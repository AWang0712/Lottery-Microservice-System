...
/**
 * @description: strategy table repository service
 */
@Component
public class StrategyRepository implements IStrategyRepository {
    ...
    public AwardBriefVO queryAwardInfo(String awardId) {
        ...
        // can use BeanUtils.copyProperties(award, awardBriefVO), or ASM-based implementations of Bean-Mapping,
        // but the best in terms of efficiency is still hard-coded.
